...
export default function AnswerCard({ response }) {
  return (
    <div className="space-y-3">
      ...
      <div className="prose prose-invert prose-sm max-w-none break-words overflow-hidden [&_p]:text-gray-300 [&_p]:leading-relaxed [&_p]:my-2 [&_li]:text-gray-300 [&_li]:leading-relaxed [&_strong]:text-gray-100 [&_h1]:text-gray-100 [&_h2]:text-gray-100 [&_h2]:mt-4 [&_h2]:mb-2 [&_h3]:text-gray-200 [&_h3]:mt-3 [&_h3]:mb-1.5 [&_a]:text-indigo-400 [&_ul]:space-y-1 [&_ul]:list-disc [&_ul]:pl-5 [&_ul]:my-2 [&_ol]:space-y-1 [&_ol]:list-decimal [&_ol]:pl-5 [&_ol]:my-2 [&_hr]:border-gray-700 [&_hr]:my-4 [&_blockquote]:border-l-2 [&_blockquote]:border-gray-600 [&_blockquote]:pl-4 [&_blockquote]:text-gray-400">
        <ReactMarkdown
          components={{
            pre({ node }) {
